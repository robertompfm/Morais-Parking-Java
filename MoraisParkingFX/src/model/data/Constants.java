...
public final class Constants {
    ...
    public static final String CREATE_USUARIOS_TABLE = "CREATE TABLE IF NOT EXISTS " +
            USUARIOS_TABLE +
            " (_id INTEGER PRIMARY KEY, username TEXT NOT NULL UNIQUE," +
            " password TEXT NOT NULL UNIQUE, tipo TEXT NOT NULL)";

    public static final String QUERY_USUARIO_BY_USERNAME = "SELECT * FROM " + USUARIOS_TABLE +
            " WHERE username = ?";
